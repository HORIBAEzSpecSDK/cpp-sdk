...
TEST_CASE("Test Weight Average Spectra Stitching",
          "[weight_average_spectra_stitch]") {
  // arrange
  ...
  SECTION("Simple overlapping spectra") {
    ...
    // act
    WeightAverageSpectraStitch stitch({s1, s2});
  ...
  SECTION("Negative values") {
    ...
    std::vector<double> expected_y = {-30.0, -113.3333333333, -103.3333333333,
                                      0.0};
  ...
  SECTION("Overlapping with same x values") {
    ...
    std::vector<double> expected_y = {10.0, 20.666666666, 31.333333333, 42.0};
  ...
  SECTION("Complete overlap") {
    ...
    std::vector<double> expected_y = {10.0, 20.0, 33.333333333, 40.0, 50.0};
