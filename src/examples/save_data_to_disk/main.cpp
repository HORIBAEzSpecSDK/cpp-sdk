 ...
 */
void save_acquisition_data_to_csv(const string& json_data, const string& csv_filename) {
 ...
 * @param csv_filename The name of the CSV file to save the data to.
 */
void save_spectracq3_data_to_csv(const vector<json>& json_data, const string& csv_filename) {
